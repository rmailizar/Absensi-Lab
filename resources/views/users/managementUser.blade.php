        ...
        <ul class="navbar-nav ms-auto align-items-center">
          ...
          <li class="nav-item dropdown mx-2">
            ...
            <ul class="dropdown-menu border-0 shadow-sm">
              <li>
                <a class="dropdown-item" href="managementUser.html"
                  >Management Admin</a
                >
              </li>
              <li>
                <a class="dropdown-item" href="managementMahasiswa.html"
    ...
    <div class="container py-5">
      <div class="card shadow-sm rounded-4">
        <div class="card-body">
          ...
          >
            <h5 class="fw-bold mb-0" style="color: #0d6efd;" >Admin Table</h5>
            <div class="d-flex align-items-center gap-2 flex-nowrap">
              ...
              >
                <i class="bi bi-person-plus me-1"></i><span>Tambah Admin</span>
              </button>
            </div>
          </div>
                ...
                <tr>
                  ...
                  <td class="text-start">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h6 class="mb-0 fw-semibold">John Michael</h6>
                        <small class="text-muted">john@creative-tim.com</small>
                      </div>
                    </div>
                  </td>
                  <td>123456789</td>
                ...
                <tr>
                  ...
                  <td class="text-start">
                    <div class="d-flex align-items-center">
                      <i class="bi bi-person-circle avatar-icon me-2"></i>
                      <div>
                        <h6 class="mb-0 fw-semibold">Alexa Liras</h6>
                        <small class="text-muted">alexa@creative-tim.com</small>
                      </div>
                    </div>
                  </td>
                  <td>987654321</td>
    ...
    <script>
      ...
      document
        ...
        .addEventListener("click", function () {
          ...
          modal.hide();
          showAlert("Perubahan data admin berhasil disimpan!");
        });
    </script>
  </body>
</html>
