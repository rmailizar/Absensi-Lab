    ...
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
        ...
        <div class="d-flex align-items-center gap-2 flex-wrap justify-content-end">
          ...
          <input type="text" class="form-control form-control-sm search-box" placeholder="Cari User..." style="width: 200px;">
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function applyFilters() {
      ...
      rows.forEach(row => {
        ...
        const matchRole = selectedRole === "semua role" || selectedRole === "" || role.includes(selectedRole);
