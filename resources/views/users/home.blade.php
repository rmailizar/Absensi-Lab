...
<style>
    ...
    */
    ...
    /* CSS Kustom untuk Teks "LabLogix"
      Kita menggunakan background-clip: text untuk membuat warna gradien di dalam teks.
    */
    .gradient-text {
        font-weight: 900;
        letter-spacing: -0.05em; /* Mirip 'tracking-tighter' */
        /* Ukuran font responsif */
        font-size: 14rem; /* Ukuran desktop besar */
    }
    ...
    .custom-navbar {
        ...
        border-radius: 50rem; /* Membuat bentuk pil */
    ...
    @media (max-width: 1200px) {
        .gradient-text { font-size: 11.5rem; }
    }
    @media (max-width: 992px) {
        .gradient-text { font-size: 9rem; }
    }
    @media (max-width: 768px) {
        .gradient-text { font-size: 7rem; }
    }
...
<x-navbar setActive="Home" />
    ...
    <main class="flex-grow-1 d-flex flex-column justify-content-center align-items-center text-center px-4 pt-5 pb-4">
        ...
        <h1 class="gradient-text" aria-label="LabLogix">
            <!--
